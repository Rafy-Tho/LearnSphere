...
export const getPlans = asyncHandler(async (req, res) => {
  ...
  return sendSuccess(res, plans, { message: "Plans retrieved successfully" });
});
...
export const deleteUserSubscription = asyncHandler(async (req, res) => {
  await subscriptionsService.deleteUserSubscription(req.params.id);
...
export const getPayments = asyncHandler(async (req, res) => {
  const payments = await subscriptionsService.getPayments();
...
export const deletePayment = asyncHandler(async (req, res) => {
  await subscriptionsService.deletePayment(req.params.id);
