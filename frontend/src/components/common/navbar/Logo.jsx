...
function Logo() {
  return (
    ...
    >
      <ChevronLeft className="text-blue-600 text-xl transition-transform group-hover:-translate-x-0.5 hidden sm:block" />
      ...
      <ChevronRight className="text-blue-600 text-xl transition-transform group-hover:translate-x-0.5 hidden sm:block" />
    </Link>
  );
}
